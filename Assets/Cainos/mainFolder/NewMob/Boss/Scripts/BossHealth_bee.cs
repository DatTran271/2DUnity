...
public class BossHealth_bee : MonoBehaviour
{
    ...
    public bossAI boss_p3;
    public BossAI_range_manyBullet boss_p4;

    public bool isInvulnerable = false;
	public bool isBossBeeDefeated = false;
