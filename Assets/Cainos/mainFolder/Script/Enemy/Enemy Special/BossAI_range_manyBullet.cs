...
public class BossAI_range_manyBullet : MonoBehaviour
{
    ...
    public GameObject projectile_4;
        ...
        else if (distanceFromPlayer <= shootingRange)
        {
            if (timeBtwShots <= 0)
            {
                ...
                myAnim.SetFloat("Y", (player.position.y - transform.position.y));
                    ...
                    Instantiate(projectile_1, transform.position, Quaternion.identity);
                    Instantiate(projectile_2, transform.position, Quaternion.identity);
                    Instantiate(projectile_3, transform.position, Quaternion.identity);
                    Instantiate(projectile_4, transform.position, Quaternion.identity);
